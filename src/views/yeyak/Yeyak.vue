...
const dataUsageList = ref([
  {
    ...
    color: "#E3F2FD",
    purpose: `
  <strong>본 예약 서비스는 원활한 예약 처리 및 고객 응대를 위해 이름과 전화번호를 수집합니다.</strong><br><br>
  수집된 개인정보는 <strong>예약 일정 확인</strong>, <strong>이용자 본인 여부 확인</strong>, <strong>서비스 제공을 위한 연락</strong> 등 정해진 목적 내에서만 이용되며, 해당 목적이 달성된 후에는 즉시 파기됩니다.<br><br>
  구체적으로는 <strong>예약이 완료되고 서비스가 제공된 후 1개월 간 보관</strong>되며, 이후에는 <strong>재생이 불가능한 방식으로 안전하게 삭제</strong>됩니다.<br><br>
  <em>이용자는 개인정보 제공에 동의하지 않을 권리가 있으나, 동의하지 않을 경우 예약 서비스 이용이 제한될 수 있습니다.</em>
`,
  ...
  이용자는 본 서비스를 이용함에 있어 다음 각 호의 행위를 해서는 안 됩니다.
  ...
  <strong>제4조 (개인정보 수집 및 보호)</strong><br>
  ...
  <strong>제6조 (약관의 변경)</strong><br>
  회사는 필요한 경우 약관을 변경할 수 있으며, 변경 시 사전에 공지합니다. 변경된 약관은 공지 시 명시된 시행일부터 효력이 발생합니다.<br><br>

  <strong>제7조 (준거법 및 재판관할)</strong><br>
  본 약관은 대한민국 법률에 따라 해석되며, 서비스와 관련된 분쟁은 회사 본사 소재지를 관할하는 법원을 제1심 법원으로 합니다.
`,
  ...
  },
  {
    ...
    color: "#E8F5E9",
    purpose: `
  본 서비스는 고객님의 편의를 위해 <strong>사전예약 방식</strong>으로 운영됩니다.<br><br>
  예약은 <strong>최소 이용 1시간 전까지 완료</strong>해주시기 바라며, 예약 후 변경이나 취소가 필요한 경우 고객센터를 통해 <strong>반드시 사전에 연락</strong>주시기 바랍니다.<br><br>

  고객님의 <strong>부주의로 인한 시간 지연, 연락 두절, 정확하지 않은 정보 입력</strong> 등으로 발생하는 불이익에 대해서는 당사가 책임지지 않습니다.<br><br>

  서비스 이용 시 기재한 연락처로 <strong>안내 메시지 또는 확인 전화를 드릴 수 있으므로, 정확한 정보를 입력</strong>해주시기 바랍니다.<br><br>

  <strong>천재지변, 시스템 장애</strong> 등 불가피한 사유로 인해 서비스가 지연되거나 취소될 수 있으며, 이 경우 고객님께 별도 안내를 드립니다.<br><br>

  예약 후 <strong>무단으로 서비스를 이용하지 않으실 경우, 이후 예약 제한이 발생</strong>할 수 있으니 유의해주시기 바랍니다.
`,
